...
$(document).ready(function(){
    ...
    var grid = [
        ...
        2,1,3,2,1,4,0,0,1,2,1,0,4,2,2,4,4,3,1,0,3,4,3,4,1,2,3,4,4,0,2,3,
        4,0,0,2,2,1,0,2,2,3,4,4,2,3,1,3,2,1,3,2,2,3,1,3,4,3,2,1,2,4,3,1,
        0,2,2,1,3,4,3,1,0,2,3,1,1,4,3,2,3,2,3,3,1,3,2,3,3,1,0,2,2,4,4,2,
        2,2,1,3,4,3,1,0,2,3,3,1,4,3,2,3,2,3,4,1,3,2,1,4,0,2,2,3,1,4,2,2,
        4,3,1,0,2,3,1,1,4,4,2,1,2,3,0,4,3,3,1,4,0,3,2,2,1,3,1,2,3,3,2,1,
        2,0,1,1,4,3,2,1,2,3,4,4,2,3,1,3,2,1,4,2,3,2,3,1,3,2,2,3,0,4,3,1,
        2,1,3,2,1,4,0,0,2,2,1,0,4,2,1,3,4,3,1,3,2,3,1,0,3,3,2,1,2,3,4,4,
        4,0,0,2,2,1,0,2,2,1,3,4,3,1,0,2,3,1,3,4,3,2,0,2,3,4,4,2,2,1,3,2,
        0,2,2,1,3,4,3,1,0,2,3,1,1,4,3,2,1,2,3,1,4,3,3,1,2,2,1,4,0,3,2,2,
    ...
    var colors = ['#ffffff', '#f40331', '#28d90e', '#0faddb', '#ffff00'];
    ...
    function buildLight() {
        for (r=0;r<nrow;r++) {
            for (c=0;c<ncol;c++) {
                ...
                var img = $("<img src='img/l"+color+".png'/>").appendTo("#light").css({opacity:0, position:'absolute', x:c*cellWidth + ligthOffSet, y:r*cellWidth + ligthOffSet});
