...
var PARAMS = [
    {
        path: "M470 350V135H420A20 20 0 1 1 440 115V165H370",
        shadow: "M470 350V135H420A20 20 0 1 1 440 115V165H370",
        orientation: 'left',
        path_end_x: 365,
        path_end_y: 165,
        font_color: "#000",
    ...
    {
        path: "M515 285V175H570A20 20 0 1 1 550 195V120H650",
        shadow: "M515 285V175H570A20 20 0 1 1 550 195V120H650",
        orientation: 'right',
        path_end_x: 645,
        path_end_y: 120,
        font_color: "#fff",
    ...
    {
        path: "M420 415V345H350V295A20 20 0 1 1 370 315H290",
        shadow: "M420 415V345H350V295A20 20 0 1 1 370 315H290",
        orientation: 'left',
        path_end_x: 285,
        path_end_y: 315,
        font_color: "#000",
    ...
    {
        path:"M565 420V315A20 20 0 1 0 545 335H580V290H640",
        shadow: "M565 420V315A20 20 0 1 0 545 335H580V290H640",
        orientation: 'right',
        path_end_x: 635,
        path_end_y: 290,
        font_color: "#000",
    ...
    {
        path: "M465 470H350A20 20 0 1 0 370 490V435H290",
        shadow: "M465 470H350A20 20 0 1 0 370 490V435H290",
        orientation: 'left',
        path_end_x: 285,
        path_end_y: 435,
        font_color: "#000",
    ...
    {
        path: "M585 340V425H630V470A20 20 0 1 1 610 450H700",
        shadow: "M585 340V425H630V470A20 20 0 1 1 610 450H700",
        orientation: 'right',
        path_end_x: 695,
        path_end_y: 450,
        font_color: "#000",
...
function WishAnim(paper,wish,index) {
    this.paper = paper;
    this.wish = wish;
...
$(document).ready(function(){
    ...
    function render_wish() {
        ...
        var wish;
        if (store.getItem('local_wish').length > 0) {
            ...
            if (wish) {
                ...
                var anim = new WishAnim(paper,wish,WISH_SEQ[idx]);
                anim.animate_wish();
            }
        }
